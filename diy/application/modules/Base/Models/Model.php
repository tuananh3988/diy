...
//	        return $this->_userData;
        ...
        public function changeTokentoUserData($uuid){
	        $SQL = "SELECT
	        			mtb_user.*,mtb_user_uuid.uuid
	        		FROM mtb_user
	        		RIGHT JOIN mtb_user_uuid ON mtb_user.id = mtb_user_uuid.mtb_user_id
	        		WHERE mtb_user_uuid.uuid = ?";
			$param = array($uuid);
        ...
        private function insertStartUserData(){
	        $SQL 			= "INSERT INTO mtb_user_uuid(uuid,created)";
