<?PHP
	class UserModel extends Model {
    	...
    	public function loginUser()
    	{
            ...
            $SQL = "DELETE FROM mtb_user
                    WHERE uuid = ? AND (login_id is null  OR  login_id = '')";
            $param = array($this->_getParam('uuid'));
            ...
            $SQL = "UPDATE mtb_user
                        SET uuid = ?
                    WHERE id = ?";
            $param = array($this->_getParam('uuid'),$loginID);
            $this -> execute($SQL,$param);
        ...
        public function createUser()
        {
            ...
            $SQL = "UPDATE mtb_user
                        SET mail       = ?,
                            ...
                            image      = ?
                    WHERE id = ? ";
            $param = array($this->_getParam('mail'),$loginID,$password,$this->_getParam('type'),$this->_getParam('name'),$this->_getParam('image',''),$this -> _userData['id']);
