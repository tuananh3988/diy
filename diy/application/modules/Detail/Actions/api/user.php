<?PHP
	class UserController extends Action {
        ...
        public function unfollowAction(){
            ...
            $this -> _special    = true;
            $this -> _retrunData = $this -> _model -> setUnfollow();
        }
        ...
        public function deleteAction(){
            ...
            $this -> _special    = true;
            $this -> _retrunData = $this -> _model -> userDelete();
        }

        public function report_spamAction(){
            $this -> _special    = true;
            $this -> _retrunData = $this -> _model -> reportSpam();
        }
    }
