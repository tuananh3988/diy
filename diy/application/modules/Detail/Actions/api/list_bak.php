<?PHP
	class ListController extends Action {
    	...
    	public function addAction(){
    		if(!$this->_itemCheck('listTitle') || !$this->_itemCheck('listText') || !$this->_itemCheck('tags')||
        ...
        public function updateAction(){
    		...
    		if(!$this->_itemCheck('listID')    || !$this->_itemCheck('listTitle') || !$this->_itemCheck('listText') || !$this->_itemCheck('tags')||
    		   !$this->_itemCheck('reshipis')  || !$this->_itemCheck('zairyos')   || !$this->_itemCheck('listType') || !$this->_itemCheck('listImage') ){
        		$this->errorEnd(パラメーター不足,"パラメーター不足");
            }
        	$this -> _special    = true;
